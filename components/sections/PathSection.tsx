...
export default function PathSection() {
  return (
    <div className="px-5 md:px-20 py-0 md:py-16">
      <div className="text-black py-10 px-5 sm:px-10 md:px-20 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
        ...
        <Button className="py-2 sm:py-3 md:py-6 px-4 sm:px-6 md:px-12 bg-white text-gray-500 border border-gray-500 w-fit sm:w-auto flex justify-center items-center gap-2">
          Schedule a free call <FaArrowDown />
        </Button>
      </div>

      <div className="flex flex-col md:flex-row gap-6 md:gap-4 px-0 md:px-6 py-2 md:py-10">
        ...
        <div className="relative flex-1 min-h-75">
          ...
          <div className="absolute inset-0 flex justify-center items-center">
            <div className="flex flex-col justify-center md:justify-between h-full p-4 md:p-6 text-white">
              <div>
