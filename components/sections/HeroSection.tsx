...
export default function HeroSection() {
  return (
    <div className="bg-[url('/images/background.svg')] bg-cover bg-center min-h-screen  w-full text-white flex flex-col">
      <Navbar />
<Logos/>
    ...
    <div className="mt-2
      ...
      <footer className="flex flex-col md:flex-row w-full border-t border-white">
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 w-full md:w-1/2 border-b md:border-b-0 md:border-r border-white px-5 sm:px-10 py-6">
          ...
          <Button
            className="w-full md:w-auto py-3 md:py-6 px-4 md:px-8 bg-black border border-white rounded-4xl shadow-[inset_6px_0_12px_rgba(255,255,255,0.6)] flex items-center justify-center gap-2"
          >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full md:w-1/2 px-5 sm:px-10 py-6 gap-4 md:gap-0 border-t md:border-t-0 md:border-l border-white">
          ...
          <div className="max-w-md text-center md:text-left">
            <p className="text-sm sm:text-base md:text-base leading-relaxed">
              Premium certified refurbished technology. Save up to 45% on IT costs while eliminating e-waste.
            </p>
          </div>
          <img
